  ...
  return (
    <div className="min-h-screen bg-xone-900 text-gray-200 flex font-sans overflow-hidden relative">
      ...
      <aside className={`
        ...
        w-64 bg-xone-900 border-r border-xone-800 flex flex-col 
      ...
      `}>
        ...
        <nav className="flex-1 py-6 flex flex-col gap-1 px-3">
          ...
          <button 
            onClick={() => { setActiveTab('keyAccounts'); setIsMobileMenuOpen(false); }}
          ...
          <button className="flex items-center p-3 rounded-lg text-gray-500 hover:bg-xone-800 hover:text-gray-300 transition-all">
            <Settings size={20} />
      ...
      {/* Main Content Area */}
      <main className="flex-1 w-full p-4 lg:p-6 overflow-y-auto bg-[#0b1121] h-screen">
        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 sticky top-0 z-10 bg-[#0b1121]/95 backdrop-blur-sm py-2 -mx-4 px-4 lg:mx-0 lg:px-0">
          <div className="flex items-center gap-3">
             <button onClick={toggleMobileMenu} className="lg:hidden p-2 bg-xone-800 rounded border border-xone-700 text-white">
                <Menu size={20} />
             </button>
